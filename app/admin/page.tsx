            ...
            <div className="flex items-center gap-6">
              <nav className="hidden lg:flex gap-6 items-center">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-red-500/20 hover:bg-red-500/30 border border-red-500/50 text-red-400 hover:text-red-300 transition rounded-lg font-semibold text-sm"
                >
                  Logout
                </button>
              </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex gap-4 mb-8 border-b border-gray-800">
            <button
              ...
              className={`px-4 py-2 font-semibold border-b-2 transition ${selectedTab === 'overview'
            ...
            <button
              ...
              className={`px-4 py-2 font-semibold border-b-2 transition ${selectedTab === 'orders'
                  ? 'border-blue-500 text-blue-400'
                  : 'border-transparent text-gray-400 hover:text-white'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 font-semibold border-b-2 transition ${selectedTab === 'integrations'
                  ? 'border-blue-500 text-blue-400'
                  : 'border-transparent text-gray-400 hover:text-white'
                }`}
            >
                      ...
                      <div key={order.id} className="border-b border-gray-800 pb-4 last:border-0">
                        <div className="flex justify-between items-start">
                          ...
                          <div className="text-right">
                            ...
                            <p className={`text-sm ${order.status === 'fulfilled' ? 'text-green-400' :
                  ...
                  <div key={order.id} className="bg-gray-900 rounded-lg p-6 border border-gray-800">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="text-right">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${order.status === 'fulfilled' ? 'bg-green-500/20 text-green-400' :
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${api.status === 'configured'
