                ...
                <section className="bg-gray-900/50 p-8 rounded-lg border border-purple-500/20">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 text-sm">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <Link href="https://git-islife.com" className="text-blue-400 hover:text-blue-300 font-semibold">git-islife.com</Link>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <Link href="https://git-truth.com" className="text-green-400 hover:text-green-300 font-semibold">git-truth.com</Link>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <Link href="https://git-isforever.com" className="text-purple-300 hover:text-purple-200 font-semibold">git-isforever.com</Link>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <Link href="https://git-islove.com" className="text-pink-300 hover:text-pink-200 font-semibold">git-islove.com</Link>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <Link href="https://git-ispower.com" className="text-orange-400 hover:text-orange-300 font-semibold">git-ispower.com</Link>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <Link href="https://git-isprivate.com" className="text-gray-400 hover:text-gray-300 font-semibold">git-isprivate.com</Link>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <Link href="https://git-ispublic.com" className="text-cyan-400 hover:text-cyan-300 font-semibold">git-ispublic.com</Link>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <Link href="https://git-isyourchoice.com" className="text-yellow-400 hover:text-yellow-300 font-semibold">git-isyourchoice.com</Link>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <Link href="https://git-iseternal.com" className="text-indigo-400 hover:text-indigo-300 font-semibold">git-iseternal.com</Link>
