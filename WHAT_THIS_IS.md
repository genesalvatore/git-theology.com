...
**Reusable Framing Snippet for READMEs, Press, and External Communication**
...
3. **Understand the framing** → Read [How to Read the Cathedral Network](https://git-theology.com/how-to-read) for full context
...
This snippet can be:
- Copied into any Cathedral Network README
- Shared with press/media inquiries
- Included in investor decks
- Referenced in community onboarding
- Linked from "About" pages

**Markdown file location:** `WHAT_THIS_IS.md` (place in root of each repository)

**Short URL suggestion:** `git-theology.com/what-this-is` (canonical version)
